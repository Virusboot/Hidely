...
#define CONFIGURE_ARGS " '--prefix=/Applications/Postgres.app/Contents/Versions/16' '--with-includes=/Applications/Postgres.app/Contents/Versions/16/include' '--with-libraries=/Applications/Postgres.app/Contents/Versions/16/lib' '--enable-thread-safety' '--with-openssl' '--with-bonjour' '--with-libxml' '--with-libxslt' '--with-python' '--with-readline' '--with-uuid=e2fs' '--with-icu' '--with-extra-version= (Postgres.app)' '--with-lz4' '--with-zstd' 'CFLAGS= -Os -mmacosx-version-min=10.13 -arch arm64 -arch x86_64' 'CXXFLAGS= -Os -mmacosx-version-min=10.13 -arch arm64 -arch x86_64' 'PKG_CONFIG_LIBDIR=/Applications/Postgres.app/Contents/Versions/16/lib/pkgconfig' 'ICU_CFLAGS=-I/Applications/Postgres.app/Contents/Versions/16/share/icu' 'ICU_LIBS=-licui18n -licuuc' 'PYTHON=/Library/Frameworks/Python.framework/Versions/3.12/bin/python3'"
...
#define PG_VERSION "16.14 (Postgres.app)"

/* PostgreSQL version as a number */
#define PG_VERSION_NUM 160014

/* A string containing the version number, platform, and C compiler */
#define PG_VERSION_STR "PostgreSQL 16.14 (Postgres.app) on aarch64-apple-darwin21.6.0, compiled by Apple clang version 14.0.0 (clang-1400.0.29.102), 64-bit"
