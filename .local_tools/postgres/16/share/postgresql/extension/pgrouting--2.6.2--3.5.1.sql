-- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
-- pgRouting extension upgrade from 2.6.2 to 3.5.1
-- generated by tools/build-extension-update-file
-- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

\echo Use "ALTER extension pgrouting update to '3.5.1'" to load this file. \quit

-------------------------------------
-- remove functions no longer in the 3.5.1 extension
-------------------------------------
